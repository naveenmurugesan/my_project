...
import cv2
#python /usr/bin/python/facerec_from_webcam_faster.py 
...
#naveen_image = face_recognition.load_image_file("naveen1.jpg")
...
alagu_image = face_recognition.load_image_file("alagu.jpg")
alagu_face_encoding = face_recognition.face_encodings(alagu_image)[0]
